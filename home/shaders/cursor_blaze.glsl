...
const vec4 TRAIL_COLOR = vec4(0.494, 0.612, 0.847, 1.0); // Kanagawa crystal blue #7E9CD8
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = TRAIL_COLOR; // same color = no clashing red accent
